...
/* Bruce
 * This is the wizard window to display and control different pane in each step.
 */
public class SignatureDiscoveryUI implements SignatureDiscoverySettingsListener{
	...
	boolean featureCreation; //Bruce: this is to test whether features generation or plug-in run (true or false)
	
	
	public SignatureDiscoveryUI(UIPluginContext context, boolean featureCreation){
...
//								DiscoverSignatures discoverSignatures = new DiscoverSignatures(log, input, featureCreation);
								
								/*
								 * BRUCE: add condition for feature creation
								 */
								if (!featureCreation) {
