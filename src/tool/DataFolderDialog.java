 ...
 *   images/middle.gif
 */
public class DataFolderDialog extends JDialog  {
    ...
    private void initComponents() {
        ...
        radioButtons[0] = new JRadioButton("(Alphabet)Tandem repeats, (Alphabet) Maximum repeats,...(Bose)");
        radioButtons[0].setActionCommand(boseCommand);
 
        radioButtons[1] = new JRadioButton("Discriminative Patterns (David Lo)");
        ...
        label = new JLabel("Please select a type of patterns", JLabel.CENTER);
